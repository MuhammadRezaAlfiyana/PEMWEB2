...
if($_POST){
    $han = new nilai($_POST['nim'], $_POST['matkul'], $_POST['uts'], $_POST['uas'], $_POST['praktikum']);
    echo '<br/>Nim : '.$han->nim;
    echo '<br/>Mata Kuliah : '.$han->matkul;
    echo '<br/>Nilai uts : '.$han->uts;
    echo '<br/>Nilai uas : '.$han->uas;
    echo '<br/>Nilai praktikum : '.$han->praktikum;
    echo '<br/>Rata-Rata : '.$han->hitung();
}
?>
</body>
</html>